...
import com.falcon.orca.enums.GeneratorCommandType;
...
@Getter
@Setter
public class GeneratorCommand extends ActorCommand implements Serializable {
    private GeneratorCommandType type;
